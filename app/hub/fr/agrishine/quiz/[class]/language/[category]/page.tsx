...
export default function LangPlayer() {
  ...
  const cat = klass === 'primary-5' ? p5LangCategoryBySlug(catSlug) : klass === 'primary-4' ? p4LangCategoryBySlug(catSlug) : klass === 'primary-3' ? p3LangCategoryBySlug(catSlug) : klass === 'primary-2' ? p2LangCategoryBySlug(catSlug) : langCategoryBySlug(catSlug)
