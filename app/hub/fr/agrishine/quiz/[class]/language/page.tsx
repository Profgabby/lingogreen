...
import { P4_LANG } from '@/app/lib/lang-p4'
import { P5_LANG } from '@/app/lib/lang-p5'
import { P6_LANG } from '@/app/lib/lang-p6'
import { JSS1_LANG } from '@/app/lib/lang-jss1'
import { JSS2_LANG } from '@/app/lib/lang-jss2'
import { JSS3_LANG } from '@/app/lib/lang-jss3'
    ...
    <main style={{ minHeight:'100vh', fontFamily:'Inter, system-ui, sans-serif', color:'#fff',
      ...
      <section style={{ maxWidth:1080, margin:'0 auto', padding:'32px 26px 64px' }}>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(280px, 1fr))', gap:20 }}>
          {(klass === 'jss-3' ? JSS3_LANG : klass === 'jss-2' ? JSS2_LANG : klass === 'jss-1' ? JSS1_LANG : klass === 'primary-6' ? P6_LANG : klass === 'primary-5' ? P5_LANG : klass === 'primary-4' ? P4_LANG : klass === 'primary-3' ? P3_LANG : klass === 'primary-2' ? P2_LANG : P1_LANG).map((cat) => {
