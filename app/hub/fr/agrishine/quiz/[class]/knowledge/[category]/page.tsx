...
export default function QuizPlayer() {
  ...
  const cat = klass === 'primary-5' ? p5CategoryBySlug(catSlug) : klass === 'primary-4' ? p4CategoryBySlug(catSlug) : klass === 'primary-3' ? p3CategoryBySlug(catSlug) : klass === 'primary-2' ? p2CategoryBySlug(catSlug) : categoryBySlug(catSlug)
